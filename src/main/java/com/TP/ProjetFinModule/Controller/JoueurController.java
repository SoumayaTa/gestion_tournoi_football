...
public class JoueurController {
    ...
    @GetMapping("/getJoueurByPosteAndEquipe/{poste}/{nomEquipe}")
    public List<Joueur> getJoueurByPosteAndEquipe(@PathVariable String poste,
                                                  @PathVariable String nomEquipe){
        return js.findJoueurByPosteAndEquipe(poste,nomEquipe);
